...
public class gtata_view extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel2.setText("You are logged In as GTA/TA");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(gtata_view.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            @Override
            public void run() {
                new gtata_view().setVisible(true);
            }
        });
    }
