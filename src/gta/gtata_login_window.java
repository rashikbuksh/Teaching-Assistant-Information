...
import gta.wron_password;
import java.io.FileNotFoundException;
import java.util.Scanner;
import java.io.File;


public class gtata_login_window extends javax.swing.JFrame {

    
    public gtata_login_window() {
        initComponents();
    }
    ...
    private void loginActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_loginActionPerformed
        ...
        try{
            ...
            File file = new File("GtataPassword.txt");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(gtata_login_window.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
